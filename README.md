...
To extract the crate documentation, `cargo-insert-docs` invokes `cargo +nightly-2026-09-24 rustdoc`. This will automatically install the required nightly toolchain.
